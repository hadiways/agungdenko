            ...
            <aside className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-[#0B1B2B] text-white border border-white/5 rounded-2xl p-5 shadow-lg relative overflow-hidden flex flex-col justify-between h-64">
                ...
                <div className="relative z-10 pt-4">
                  <a
                    href="https://wa.me/6285784380347?text=Halo%20Pak%20Agung%20Ramdhani,%20saya%20ingin%20berkonsultasi%20mengenai%20kebutuhan%20forklift%20perusahaan%20saya."
                    target="_blank"
                    rel="noopener noreferrer"
