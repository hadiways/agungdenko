...
export default function ShareButtons({ title }) {
  ...
  return (
    <div className="flex flex-col gap-3 py-6 border-y border-gray-100">
      <span className="text-gray-400 text-xs font-bold uppercase tracking-wider">Bagikan Artikel</span>
      <div className="flex gap-2">
        <a
          href={`https://wa.me/?text=${encodedTitle}%20${encodedUrl}`}
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-xl bg-[#25D366] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-sm"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-xl bg-[#1877F2] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-sm"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-xl bg-[#0A66C2] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-sm"
